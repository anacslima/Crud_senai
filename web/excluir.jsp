    ...
    <head>
        ...
        <style>
            ...
            button {
                font-size: 16px;
                padding: 10px 20px;
                margin: 2px; /* Reduzido para aproximar os botões */
                cursor: pointer;
                border-radius: 5px;
                border: none;
        ...
        <%
            ...
            if ("sim".equals(confirmar)) {
                ...
                try {
                    ...
                    if (resultado == 0) {
                        out.print("Este contato não está cadastrado.");
                    } else {
                ...
                // Se o parâmetro 'confirmar' for igual a 'nao', volta para a página anterior
                out.print("<p>Operação cancelada. Voltando à página anterior...</p>");
            } else {
